...
import com.lagradost.cloudstream3.stremioproviders.StremioPluginAPI
import java.util.*
...
object APIHolder {
    ...
    val restrictedApis = arrayListOf(
        ...
        AsiaFlixProvider(),
        StremioPluginAPI("https://learn-programming.baby-supernode.xyz/manifest.json", "Learn Programming"),
        StremioPluginAPI("https://stremio-imvdb.tgr.ax/manifest.json", "IMVDb Music Videos"),
        StremioPluginAPI("https://94c8cb9f702d-tmdb-addon.baby-beamup.club/manifest.json", "The Movie Database Addon")
    )
